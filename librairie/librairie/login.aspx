...
<head>
    ...
    <title>Login - Librairie LIGHT PAGE</title>
  ...
  <nav class="bg-yellow-700">
    ...
    <main class="flex justify-center items-center min-h-screen">
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            <h2 class="text-2xl font-bold mb-6 text-center">Connexion utilisateur</h2>
            <form action="#" method="post" class="space-y-4">
                ...
                <button type="submit" class="w-full bg-yellow-600 text-white p-2 rounded hover:bg-yellow-700 transition duration-200">Se connecter</button>
            </form>
            <div class="flex justify-between items-center mt-4">
                <a href="mot-de-passe-oublie.aspx" class="text-sm text-yellow-600 hover:underline">Mot de passe oublié?</a>
                <a href="inscription.aspx" class="text-sm text-yellow-600 hover:underline">Inscription</a>
            </div>
        </div>
    </main>
</body>
