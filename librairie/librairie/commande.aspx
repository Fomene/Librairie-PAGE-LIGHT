...
<head>
    ...
    <title>Commandes - Librairie LIGHT PAGE</title>
...
<body class="bg-gray-100">
  ...
  <nav class="bg-yellow-700">
    ...
    <header class="bg-yellow-600 text-white text-center py-6">
        <h1 class="text-4xl font-bold">Passer une Commande</h1>
    </header>
    <main class="flex justify-center items-center min-h-screen">
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            <h2 class="text-2xl font-bold mb-6 text-center">Formulaire de commande</h2>
            <form action="#" method="post" class="space-y-4">
                ...
                <div>
                    <label for="livre" class="block text-gray-700">Livre :</label>
                    <input type="text" id="livre" name="livre" required class="w-full p-2 border border-gray-300 rounded mt-1">
                </div>
                <div>
                    <label for="quantite" class="block text-gray-700">Quantité :</label>
                    <input type="number" id="quantite" name="quantite" required class="w-full p-2 border border-gray-300 rounded mt-1">
                </div>
                <button type="submit" class="w-full bg-yellow-600 text-white p-2 rounded hover:bg-yellow-700 transition duration-200">Commander</button>
            </form>
        </div>
    </main>
</body>
